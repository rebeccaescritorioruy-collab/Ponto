  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-xs text-neutral-500">
        O limitador de localização (geofencing) agora é configurado por cidade, na aba <strong>Sedes</strong> —
        essa aqui guarda só os dados da empresa que aparecem nos comprovantes e no espelho de ponto.
      </p>
